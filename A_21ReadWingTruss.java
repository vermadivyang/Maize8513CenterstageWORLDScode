...
@Autonomous(name="2+1|RedWingTruss", group="Worlds_Read")

public class A_21ReadWingTruss extends LinearOpMode {
    ...
    public void runOpMode() {
       ...
       while(!isStarted()) {
        ...
        Action PushPixelIGF = drive.actionBuilder(drive.pose) // Pushes and drops pixel
        ...
        Action DropPixelBBNB = drive.actionBuilder(drive.pose) // Drops the pixel on the Backdrop
                .stopAndAdd(BucketAuto.BucketGateOpen())
                .waitSeconds(.75)
                .stopAndAdd(BucketAuto.BucketGateClose())
                .waitSeconds(.09)
        ...
        waitForStart();
            ...
            if (OD.getIntLocation() == 3) { // If the location is 3 then do ...
                ...
                Actions.runBlocking(new SequentialAction(
                        ...
                        drive.MoveXYACEL(41, 0, -20, 26),//-20,50(10)
                        drive.MoveXY(0, -5.6),
                        PushPixelIG,
                        drive.MoveXY(-8, 8),
                        drive.rotate(4)
                ...
                Actions.runBlocking(new SequentialAction(
                        ...
                        Intake.RealInverse(),
                        drive.TurnMoveXY(-30.8, 5),// -25

                        drive.TurnMoveXY(-1, 75),
                        drive.TurnMoveXY(19, 2),// 30
                                BucketAuto.BucketOpen(),
                                Lift.Pos2(),
                                drive.waitS(.24),
