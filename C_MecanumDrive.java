...
public final class C_MecanumDrive extends OpMode{
  ...
  //      public double kV =  0.00011370942725399379;//0.00011575386884492354
    ...
    public class DriveELocalizer implements E_Localizer {
        ...
        public DriveELocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(C_MecanumDrive.this.leftFront));
            rightFront = new OverflowEncoder(new RawEncoder(C_MecanumDrive.this.rightFront));
            leftRear = new OverflowEncoder(new RawEncoder(C_MecanumDrive.this.leftBack));
            rightRear = new OverflowEncoder(new RawEncoder(C_MecanumDrive.this.rightBack));
    ...
    public C_MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
