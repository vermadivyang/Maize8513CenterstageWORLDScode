...
public final class C_AutoMecanumDrive extends OpMode{
  ...
  //      public double kV =  0.00011370942725399379;//0.00011575386884492354
    ...
    public class DriveELocalizer implements E_Localizer {
        ...
        public DriveELocalizer() {
            leftFront = new OverflowEncoder(new RawEncoder(C_AutoMecanumDrive.this.leftFront));
            rightFront = new OverflowEncoder(new RawEncoder(C_AutoMecanumDrive.this.rightFront));
            leftRear = new OverflowEncoder(new RawEncoder(C_AutoMecanumDrive.this.leftBack));
            rightRear = new OverflowEncoder(new RawEncoder(C_AutoMecanumDrive.this.rightBack));
    ...
    public C_AutoMecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        this.pose = pose;
        ...
        */
        ...
        IMU.Parameters parameters = new IMU.Parameters(new RevHubOrientationOnRobot(
                RevHubOrientationOnRobot.LogoFacingDirection.UP, // UP, left
                RevHubOrientationOnRobot.UsbFacingDirection.FORWARD)); // FORWARD, up
    ...
    public Action MoveXY(double xMove31, double yMove31) {
       ...
       // double newxMove31 = xMove31;
        xMove31 = (xMove31 * 1.174) + 4.118;
        yMove31 = yMove31 * 0.9;
